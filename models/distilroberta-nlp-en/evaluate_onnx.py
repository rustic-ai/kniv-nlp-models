...
Usage:
    python models/distilroberta-nlp-en/evaluate_onnx.py \\
        --onnx-path onnx-output/distilroberta-nlp-en/model-int8.onnx \\
        --pytorch-results outputs/distilroberta-nlp-en/final/eval_results.json
"""
