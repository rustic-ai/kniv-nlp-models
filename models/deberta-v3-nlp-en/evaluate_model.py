...
Usage:
    python models/deberta-v3-nlp-en/evaluate_model.py --model-dir outputs/deberta-v3-nlp-en/final
"""
...
def main():
    ...
    parser.add_argument("--encoder", default="microsoft/deberta-v3-small")
